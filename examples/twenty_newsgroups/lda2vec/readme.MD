...
| - | - | - | - | - | - |
| L.NegativeSampling | _**context vector**_ | _**target word**_ | lda2vec_model.py:fit_partial() | For each mini-batch...<br>&nbsp;&nbsp;_do loss.backward() in each moving frame window_ | _**L**_ |
