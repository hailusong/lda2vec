...
| - | - | - | - |
| L.NegativeSampling | lda2vec_model.py:fit_partial() | loss.backward in each moving frame window | _**L**_ |
| dirichlet_likelihood * fraction | lda2vec_run.py | loss.backward() in each mini-batch | _**P**_ |
